...
async def brief_writer(
    ...
    notes_instruction += (
        f"\nThis is summarization of the user query. Interpretate it at the beggining of the answer:\n{interpretation_notes}\n"
        if interpretation_notes
        else ""
    )

    notes_instruction += f"\nThese are the most recent articles from that area and sector: {articles}. Summarise them in the introduction."
